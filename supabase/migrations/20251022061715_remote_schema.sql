alter table "public"."coupons" alter column "code" set default md5((random())::text);

alter table "public"."eventLevels" add column "hp" bigint;

alter table "public"."eventLevels" add column "requiredLevel" bigint;

alter table "public"."events" add column "type" text not null default 'basic'::text;

alter table "public"."players" add column "overviewData" jsonb;

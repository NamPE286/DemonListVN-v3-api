alter table "public"."inventory" drop constraint "playerMedal_medalID_fkey";

alter table "public"."inventory" drop constraint "playerMedal_pkey";

drop index if exists "public"."playerMedal_pkey";

alter table "public"."inventory" drop column "medalID";

alter table "public"."inventory" add column "itemId" bigint not null;

alter table "public"."players" alter column "uid" set default extensions.uuid_generate_v4();

CREATE UNIQUE INDEX "playerMedal_pkey" ON public.inventory USING btree ("userID", "itemId");

alter table "public"."inventory" add constraint "playerMedal_pkey" PRIMARY KEY using index "playerMedal_pkey";

alter table "public"."inventory" add constraint "inventory_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES items(id) not valid;

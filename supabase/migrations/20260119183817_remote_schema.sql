...
ALTER TABLE ONLY "public"."subscriptions"
    ADD CONSTRAINT "subscriptions_pkey" PRIMARY KEY ("type", "userID");
...
ALTER TABLE ONLY "public"."subscriptions"
    ADD CONSTRAINT "subscriptions_userID_fkey" FOREIGN KEY ("userID") REFERENCES "public"."players"("uid") ON UPDATE CASCADE;

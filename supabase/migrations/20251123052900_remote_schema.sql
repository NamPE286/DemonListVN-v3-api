alter table "public"."eventQuests" drop constraint "eventQuests_rewardItemId_fkey";
...
alter table "public"."eventQuests" drop column "rewardItemId";
...
alter table "public"."eventQuestRewards" add constraint "eventQuestRewards_questId_fkey" FOREIGN KEY ("questId") REFERENCES "eventQuests"(id) not valid;

alter table "public"."eventQuestRewards" validate constraint "eventQuestRewards_questId_fkey";

alter table "public"."eventQuestRewards" add constraint "eventQuestRewards_rewardId_fkey" FOREIGN KEY ("rewardId") REFERENCES items(id) not valid;

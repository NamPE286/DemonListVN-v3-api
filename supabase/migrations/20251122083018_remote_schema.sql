...
alter table "public"."caseItems" add column "id" bigint generated by default as identity not null;
...
CREATE UNIQUE INDEX "caseItems_pkey" ON public."caseItems" USING btree ("itemId", "caseId", quantity);
...
alter table "public"."caseResult" add constraint "caseResult_caseId_fkey" FOREIGN KEY ("resultId") REFERENCES items(id) not valid;

alter table "public"."caseResult" validate constraint "caseResult_caseId_fkey";

alter table "public"."caseResult" add constraint "caseResult_resultId_fkey" FOREIGN KEY ("resultId") REFERENCES "caseItems"(id) not valid;

...
alter table "public"."items" add column "productId" bigint;

alter table "public"."players" alter column "uid" set default extensions.uuid_generate_v4();

alter table "public"."caseItems" add constraint "caseItems_caseId_fkey" FOREIGN KEY ("caseId") REFERENCES items(id) not valid;

alter table "public"."caseItems" validate constraint "caseItems_caseId_fkey";

alter table "public"."caseItems" add constraint "caseItems_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES items(id) not valid;

alter table "public"."caseItems" validate constraint "caseItems_itemId_fkey";

alter table "public"."items" add constraint "items_productId_fkey" FOREIGN KEY ("productId") REFERENCES products(id) not valid;

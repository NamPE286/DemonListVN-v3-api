...
ALTER TABLE ONLY "public"."records"
    ADD CONSTRAINT "records_levelid_fkey" FOREIGN KEY ("levelid") REFERENCES "public"."levels"("id");

ALTER TABLE ONLY "public"."records"
    ADD CONSTRAINT "records_userid_fkey" FOREIGN KEY ("userid") REFERENCES "public"."players"("uid");

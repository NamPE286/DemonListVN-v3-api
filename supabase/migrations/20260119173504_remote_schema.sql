...
alter table "public"."userSocial" drop constraint "userSocial_userid_fkey";
  ...
  create table "public"."battlePass" (
...
alter table "public"."battlePass" enable row level security;

alter table "public"."items" add column "defaultExpireAfter" bigint;

alter table "public"."players" alter column "uid" set default extensions.uuid_generate_v4();

CREATE UNIQUE INDEX "battlePass_pkey" ON public."battlePass" USING btree (id);

alter table "public"."battlePass" add constraint "battlePass_pkey" PRIMARY KEY using index "battlePass_pkey";
...
grant delete on table "public"."battlePass" to "anon";

grant insert on table "public"."battlePass" to "anon";

grant references on table "public"."battlePass" to "anon";

grant select on table "public"."battlePass" to "anon";

grant trigger on table "public"."battlePass" to "anon";

grant truncate on table "public"."battlePass" to "anon";

grant update on table "public"."battlePass" to "anon";

grant delete on table "public"."battlePass" to "authenticated";

grant insert on table "public"."battlePass" to "authenticated";

grant references on table "public"."battlePass" to "authenticated";

grant select on table "public"."battlePass" to "authenticated";

grant trigger on table "public"."battlePass" to "authenticated";

grant truncate on table "public"."battlePass" to "authenticated";

grant update on table "public"."battlePass" to "authenticated";

grant delete on table "public"."battlePass" to "service_role";

grant insert on table "public"."battlePass" to "service_role";

grant references on table "public"."battlePass" to "service_role";

grant select on table "public"."battlePass" to "service_role";

grant trigger on table "public"."battlePass" to "service_role";

grant truncate on table "public"."battlePass" to "service_role";

grant update on table "public"."battlePass" to "service_role";

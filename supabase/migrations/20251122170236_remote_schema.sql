alter table "public"."caseResult" add column "openerId" uuid not null;

alter table "public"."players" alter column "uid" set default extensions.uuid_generate_v4();

alter table "public"."caseResult" add constraint "caseResult_openerId_fkey" FOREIGN KEY ("openerId") REFERENCES players(uid) not valid;

alter table "public"."eventProofs" drop constraint "eventProofs_content_check";

alter table "public"."eventProofs" alter column "content" set default ''::text;

alter table "public"."events" add column "minExp" bigint not null default '0'::bigint;

alter table "public"."events" add column "needProof" boolean not null default true;

alter table "public"."events" alter column "start" set default now();

alter table "public"."levels" add column "isPlatformer" boolean not null default false;

alter table "public"."records" add column "time" bigint;

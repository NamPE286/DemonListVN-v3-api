alter table "public"."eventLevels" drop column "minProgress";

alter table "public"."eventLevels" add column "minEventProgress" double precision not null default '0'::double precision;

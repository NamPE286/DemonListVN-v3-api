revoke delete on table "public"."stackableItemTransactions" from "anon";

revoke insert on table "public"."stackableItemTransactions" from "anon";

revoke references on table "public"."stackableItemTransactions" from "anon";

revoke select on table "public"."stackableItemTransactions" from "anon";

revoke trigger on table "public"."stackableItemTransactions" from "anon";

revoke truncate on table "public"."stackableItemTransactions" from "anon";

revoke update on table "public"."stackableItemTransactions" from "anon";

revoke delete on table "public"."stackableItemTransactions" from "authenticated";

revoke insert on table "public"."stackableItemTransactions" from "authenticated";

revoke references on table "public"."stackableItemTransactions" from "authenticated";

revoke select on table "public"."stackableItemTransactions" from "authenticated";

revoke trigger on table "public"."stackableItemTransactions" from "authenticated";

revoke truncate on table "public"."stackableItemTransactions" from "authenticated";

revoke update on table "public"."stackableItemTransactions" from "authenticated";

revoke delete on table "public"."stackableItemTransactions" from "service_role";

revoke insert on table "public"."stackableItemTransactions" from "service_role";

revoke references on table "public"."stackableItemTransactions" from "service_role";

revoke select on table "public"."stackableItemTransactions" from "service_role";

revoke trigger on table "public"."stackableItemTransactions" from "service_role";

revoke truncate on table "public"."stackableItemTransactions" from "service_role";

revoke update on table "public"."stackableItemTransactions" from "service_role";

alter table "public"."stackableItemTransactions" drop constraint "stackableItemTransactions_itemID_fkey";
...
alter table "public"."stackableItemTransactions" drop constraint "stackableItemTransactions_pkey";

drop index if exists "public"."stackableItemTransactions_pkey";

drop table "public"."stackableItemTransactions";
...
CREATE UNIQUE INDEX "stackableItemTransactions_pkey" ON public."itemTransactions" USING btree (id);

alter table "public"."itemTransactions" add constraint "stackableItemTransactions_pkey" PRIMARY KEY using index "stackableItemTransactions_pkey";
...
grant delete on table "public"."itemTransactions" to "anon";

grant insert on table "public"."itemTransactions" to "anon";

grant references on table "public"."itemTransactions" to "anon";

grant select on table "public"."itemTransactions" to "anon";

grant trigger on table "public"."itemTransactions" to "anon";

grant truncate on table "public"."itemTransactions" to "anon";

grant update on table "public"."itemTransactions" to "anon";

grant delete on table "public"."itemTransactions" to "authenticated";

grant insert on table "public"."itemTransactions" to "authenticated";

grant references on table "public"."itemTransactions" to "authenticated";

grant select on table "public"."itemTransactions" to "authenticated";

grant trigger on table "public"."itemTransactions" to "authenticated";

grant truncate on table "public"."itemTransactions" to "authenticated";

grant update on table "public"."itemTransactions" to "authenticated";

grant delete on table "public"."itemTransactions" to "service_role";

grant insert on table "public"."itemTransactions" to "service_role";

grant references on table "public"."itemTransactions" to "service_role";

grant select on table "public"."itemTransactions" to "service_role";

grant trigger on table "public"."itemTransactions" to "service_role";

grant truncate on table "public"."itemTransactions" to "service_role";

grant update on table "public"."itemTransactions" to "service_role";

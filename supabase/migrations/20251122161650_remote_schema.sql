alter table "public"."caseItems" drop constraint "caseItems_rarity_check";

alter table "public"."caseItems" drop constraint "caseItems_pkey";

alter table "public"."inventory" drop constraint "playerMedal_pkey";

drop index if exists "public"."caseItems_pkey";

drop index if exists "public"."playerMedal_pkey";

alter table "public"."caseItems" drop column "quantity";

alter table "public"."caseItems" drop column "rarity";

alter table "public"."items" add column "quantity" bigint not null default '1'::bigint;

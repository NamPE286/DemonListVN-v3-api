...
CREATE TABLE IF NOT EXISTS "public"."battlePassCourseEntries" (
    ...
    "rewardItemId" bigint,
    "rewardQuantity" integer DEFAULT 1 NOT NULL,
...
ALTER TABLE "public"."battlePassCourseEntries" OWNER TO "postgres";


ALTER TABLE "public"."battlePassCourseEntries" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."battlePassCourseEntries_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."battlePassCourseEntryProgress" OWNER TO "postgres";
...
ALTER TABLE "public"."battlePassCourses" OWNER TO "postgres";


ALTER TABLE "public"."battlePassCourses" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."battlePassCourses_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."playerConvictions" OWNER TO "postgres";


ALTER TABLE "public"."playerConvictions" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."playerConvictions_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."record_cards" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."record_cards" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."battlePassCourseEntries"
    ADD CONSTRAINT "battlePassCourseEntries_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."battlePassCourseEntryProgress"
    ADD CONSTRAINT "battlePassCourseEntryProgress_pkey" PRIMARY KEY ("entryId", "userID");



ALTER TABLE ONLY "public"."battlePassCourses"
    ADD CONSTRAINT "battlePassCourses_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."record_cards"
...
CREATE INDEX "battlePassCourseEntries_courseId_sortOrder_idx" ON "public"."battlePassCourseEntries" USING "btree" ("courseId", "sortOrder");



CREATE INDEX "battlePassCourseEntryProgress_userID_idx" ON "public"."battlePassCourseEntryProgress" USING "btree" ("userID");
...
ALTER TABLE ONLY "public"."battlePassCourseEntries"
    ADD CONSTRAINT "battlePassCourseEntries_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "public"."battlePassCourses"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."battlePassCourseEntries"
    ADD CONSTRAINT "battlePassCourseEntries_rewardItemId_fkey" FOREIGN KEY ("rewardItemId") REFERENCES "public"."items"("id") ON UPDATE CASCADE ON DELETE SET NULL;



ALTER TABLE ONLY "public"."battlePassCourseEntryProgress"
    ADD CONSTRAINT "battlePassCourseEntryProgress_entryId_fkey" FOREIGN KEY ("entryId") REFERENCES "public"."battlePassCourseEntries"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."battlePassCourseEntryProgress"
    ADD CONSTRAINT "battlePassCourseEntryProgress_userID_fkey" FOREIGN KEY ("userID") REFERENCES "public"."players"("uid") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."battlePassSeasons"
    ADD CONSTRAINT "battlePassSeasons_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "public"."battlePassCourses"("id") ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE "public"."record_cards" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."battlePassCourseEntries" TO "anon";
GRANT ALL ON TABLE "public"."battlePassCourseEntries" TO "authenticated";
GRANT ALL ON TABLE "public"."battlePassCourseEntries" TO "service_role";



GRANT ALL ON SEQUENCE "public"."battlePassCourseEntries_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."battlePassCourseEntries_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."battlePassCourseEntries_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."battlePassCourseEntryProgress" TO "anon";
GRANT ALL ON TABLE "public"."battlePassCourseEntryProgress" TO "authenticated";
GRANT ALL ON TABLE "public"."battlePassCourseEntryProgress" TO "service_role";



GRANT ALL ON TABLE "public"."battlePassCourses" TO "anon";
GRANT ALL ON TABLE "public"."battlePassCourses" TO "authenticated";
GRANT ALL ON TABLE "public"."battlePassCourses" TO "service_role";



GRANT ALL ON SEQUENCE "public"."battlePassCourses_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."battlePassCourses_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."battlePassCourses_id_seq" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."playerConvictions_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."playerConvictions_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."playerConvictions_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."record_cards" TO "anon";
GRANT ALL ON TABLE "public"."record_cards" TO "authenticated";
GRANT ALL ON TABLE "public"."record_cards" TO "service_role";

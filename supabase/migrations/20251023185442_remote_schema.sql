alter table "public"."eventLevels" add column "minProgress" double precision not null default '0'::double precision;

alter table "public"."eventLevels" alter column "totalProgress" set default '0'::double precision;

alter table "public"."eventLevels" alter column "totalProgress" set not null;

alter table "public"."eventLevels" alter column "totalProgress" set data type double precision using "totalProgress"::double precision;

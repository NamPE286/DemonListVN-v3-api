...
alter table "public"."players" drop column "platformerRank";

alter table "public"."players" drop column "platformerRating";

alter table "public"."players" add column "plRating" bigint;

alter table "public"."players" add column "plrank" bigint;

alter table "public"."players" alter column "uid" set default extensions.uuid_generate_v4();

alter table "public"."records" drop column "time";

alter table "public"."records" add column "plPt" double precision;
